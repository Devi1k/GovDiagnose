...
requirement_weight = [
    ...
    {'机动车登记与临时通行牌证核发-机动车登记': 100, '机动车登记被依法撤销': 100, '汽车': 30, '机动车': 30, '登记': 30, '依法': 30, '撤销': 50, '登记地': 10,
     '车辆管理所': 10, '注销': 10},
    {'机动车登记与临时通行牌证核发-机动车登记': 100, '被依法收缴并强制报废': 100, '汽车': 30, '机动车': 30, '达到': 10, '国家': 10, '强制': 10, '报废': 10,
     '标准': 10, '依法': 30, '收缴': 50,
     '登记地': 10, '车辆管理所': 10, '注销': 10, '登记': 10},
    {'客运出租汽车经营资格证件核发-客运出租汽车经营资格证核发': 100, '客运出租汽车经营资格证核发': 100, '客运出租汽车经营资格证': 100, '客运出租汽车': 90, '核发': 10, '客运': 30,
     '出租': 80,
     '汽车': 30, '经营': 30,
     '资格证': 30},
    {'客运出租汽车经营资格证件核发-网络预约出租汽车驾驶员证核发-网络预约出租汽车驾驶员证核发': 100, '网络预约出租汽车驾驶员证核发': 100, '网络预约出租汽车驾驶员证': 100, '网络预约出租汽车': 80,
     '网络': 40, '预约': 80,
     '出租': 50, '汽车': 40, '驾驶员证': 30, '核发': 10, '行驶证': 30, '申请': 10},
    {'客运出租汽车经营资格证件核发-驾驶员客运资格证核发': 100, '驾驶员客运资格证核发': 100, '驾驶员客运资格证': 100, '客运': 50, '驾驶员': 30, '资格证': 30, '核发': 10,
     '职业培训': 30,
     '考试合格': 10},
    {'教师资格的认定': 100, '认定教师资格': 100, '教师资格': 100, '认定': 10, '学校': 30, '教师': 80, '资格': 30, '考试合格': 10},
    {'养犬登记': 100, '养犬': 100, '饲养': 50, '犬': 50, '登记': 10, '狗': 50, '寄养': 50},
    {'港澳台居民定居证明签发': 100, '港澳台居民来大陆定居': 100, '台湾': 50, '定居': 50, '大陆': 30, '居民': 10, '申请': 10},
    ...
    {'外国人居留停留-外国人居留证件的签发、延期、换发、补发-团聚类居留证件签发、延期、换发、补发': 100, '团聚类居留证件': 100, '外国人': 30, '团聚': 50, '居留': 50,
     '证件': 10, '签发': 10, '延期': 10, '换发': 10, '补发': 10, '申请': 10,
     '家庭': 10, '中国': 10, '境内': 10, '公民': 10, '成员': 10, '永久': 10, '资格': 10, '寄养': 10},
    {'外国人居留停留-外国人居留证件的签发、延期、换发、补发-学习类居留证件签发、延期、换发、补发': 100, '学习类居留证件': 100, '外国人': 30, '学习': 50, '居留': 50,
     '证件': 10, '签发': 10, '延期': 10, '换发': 10, '补发': 10},
    {'外国人居留停留-外国人居留证件的签发、延期、换发、补发-工作类居留证件签发、延期、换发、补发': 100, '工作类居留证件': 100, '外国人': 30, '工作': 50, '居留': 50,
     '证件': 10, '签发': 10, '延期': 10, '换发': 10, '补发': 10, '中国': 10,
     '境内': 10},
    {'外国人居留停留-外国人居留证件的签发、延期、换发、补发-记者类居留证件签发、延期、换发、补发': 100, '记者类居留证件': 100, '外国人': 30, '记者': 50, '居留': 50,
    ...
    {'户外广告及临时悬挂、设置标语或者宣传品许可--户外广告设施许可（不含公交候车亭附属广告及公交车体广告设施）（市级权限委托市内六区实施）': 100,
     '户外广告设施': 100, '户外广告设施许可': 100, ' 符合': 30, '户外': 50, '广告': 80, '门头': 80, '牌匾': 80, '招牌': 80, '设置': 30, '规划': 30,
     '周围': 30,
     '建筑': 30, '街景': 30, '环境': 30, '协调': 10, '规范': 30, '新技术': 30, '新材料': 30, '设施': 10, '许可': 10}
]
# 各业务的权重值最大的关键词
slot_max_weight = {'首次申请护照': 100, '护照加注': 100, '护照补发': 100, '换发护照': 100, '初次申领机动车号牌和行驶证': 100, '改变车身颜色': 100,
                   ...
                   '因质量问题退车': 100, '机动车登记被依法撤销': 100, '被依法收缴并强制报废': 100, '客运出租汽车经营资格证核发': 100,
                   '网络预约出租汽车驾驶员证核发': 100, '驾驶员客运资格证核发': 100, '认定教师资格': 100, '养犬': 100, '台湾居民来大陆定居': 100,
                   '前往港澳定居后返回内地定居': 100, '台湾居民来往大陆通行证': 100, '大陆居民往来台湾通行证': 100, '出入境通行证': 100, '外国人停留证件': 100,
                   '团聚类居留证件': 100, '学习类居留证件': 100, '工作类居留证件': 100, '记者类居留证件': 100, '内地居民往来港澳通行证': 100,
                   '户外广告设施许可': 100}
